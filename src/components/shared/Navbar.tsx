      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-bold text-slate-900 text-sm block">K.M. Engineering</span>
          ...
          <Button
            ...
            size="icon"
            onClick={() => setIsOpen(false)}
            className="h-8 w-8 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-200/60"
          >
            <X className="h-5 w-5" />
          </Button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ChevronRight
                    className={`h-4 w-4 transition-transform duration-200 ${
                      isActive ? "text-brand-primary translate-x-0.5" : "text-slate-300 group-hover:text-slate-500"
                    }`}
                  />
                </div>
              </Link>
          ...
          <div className="mt-6 p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2">
            ...
            <a href="tel:+919876543210" className="flex items-center gap-2.5 text-xs text-slate-700 hover:text-brand-primary font-medium">
              <PhoneCall className="h-3.5 w-3.5 text-emerald-600 shrink-0" />
              <span>+91 98765 43210</span>
            </a>
            <a href="mailto:info@kmengineering.com" className="flex items-center gap-2.5 text-xs text-slate-700 hover:text-brand-primary font-medium">
